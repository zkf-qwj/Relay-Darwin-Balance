...
class RTSPRequestInterface : public QTSSDictionary
{
    public:
       ...
       //zlj add 20161208 
		UInt32						GetTransportUserAgentMode()			{ return fTransportUserAgentMode; }
        void                      SetTransportUserAgentMode( UInt32  type)            { fTransportUserAgentMode = type;}
    protected:
    ...
    private:
		...
		UInt32 fTransportUserAgentMode; //zlj add 20161208 
